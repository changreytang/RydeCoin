...
class HttpServer {
    constructor(node, blockchain, operator, miner) {
        ...
        this.app.post('/rydecoin/book_ride/',(req,res) => {
            ...
            if (walletAddresses.indexOf(req.body.addressId) === -1)  throw new HTTPError(403, `Invalid address for wallet '${walletId}'`);
            ...
            try{
                ...
                let newTransaction =operator.createTransaction_v1(walletId, addressId , managerAddress, amount , addressId , rideInfo , 'book_ride');
            ...
            //res.redirect('/rydecoin');
            //res.status(200).send('Ride Booked');
