...
class Operator {
    constructor(dbName, blockchain, name, host, port) {
        ...
        if (this.wallets.length == 0) {
            ...
            let managerWallet = this.addWallet(this.createWalletFromPassword(managerPassword));
            this.generateAddressForWallet(managerWallet.id);
        }
    ...
    managerMine() {
        exec(`./lib/manager_mine ${this.host} ${this.port} ${this.getManagerAddress()} `)
    }
